...
with tab1:
    ...
    # Cache file upload section in collapsible expander
    with st.expander("🗂️ Optional: Upload Cache Files", expanded=False):
    ...
    # Quick Start section
    with st.expander("🚀 Quick Start with Cache Files", expanded=False):
        st.markdown("""
